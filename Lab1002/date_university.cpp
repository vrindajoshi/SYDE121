...
Date::Date(const int newday, const int newmonth, const int newyear)
  ...
  //   cout << "executing Date::Date( const int newday, const int newmonth,
  //   const "
  //           "int newyear ) :";
...
void Date::set_day(const int newday) { day = newday; }

void Date::set_month(const int newmonth) { month = newmonth; }

void Date::set_year(const int newyear) { year = newyear; }
